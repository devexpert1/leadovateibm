...
Auth::routes();
Route::get('/demo_captha/{id}', 'HomeController@demo_captha')->name('demo_captha');
Route::post('/loginuser', 'Auth\LoginController@login')->name('loginuser');
Route::post('/submit_demo', 'HomeController@submit')->name('submit');
...
Route::match(array('GET','POST'),'/register_user', 'Controller@register_user');
...
Route::post('/user/postPaymentWithStripe', 'HomeController@postPaymentWithStripe')->name('postPaymentWithStripe');
Route::post('/user/postPaymentWithStripeupdate', 'HomeController@postPaymentWithStripeupdate')->name('postPaymentWithStripeupdate');
Route::post('/user/facebooklogin', 'HomeController@facebooklogin')->name('facebooklogin');	
Route::post('/user/linked_login', 'HomeController@linked_login')->name('linked_login');	
Route::post('/user/instalogin', 'HomeController@instalogin')->name('instalogin');	
...
Route::match(array('GET','POST'),'/course-details/syllabus/{id}', 'HomeController@course_details')->name('course-details');	
...
//admin routes
Route::get('/courses_purchased/{id}', 'AdminController@courses_purchased');
Route::post('/updateorder', 'AdminController@updateorder');
Route::post('/get_results', 'AdminController@get_results');
Route::get('/stripe', 'AdminController@stripe');
Route::post('/delete_notification', 'AdminController@delete_notification');
...
Route::get('/referral_list', 'AdminController@referral_list')->name('referral_list');	
...
Route::match(array('GET','POST'),'/privacy_policy', 'AdminController@privacy_policy')->name('admin.privacy_policy');
