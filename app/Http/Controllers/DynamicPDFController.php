...
function get_customer_data1($id,$user_id)
{
      ...
      function convert_customer_data_to_html($id)
    {
        ...
        $output .= '
        <tr>
        <th style="border: 1px solid; padding:12px;width:34px;word-break: break-word;">Activity Title </th>
        <th style="border: 1px solid; padding:12px;">Description </th>
        <th style="border: 1px solid; padding:12px;">Participation grade level </th>
          <th style="border: 1px solid; padding:12px;">Timing of participation </th>
        ...
        <tr>
        <td style="border: 1px solid; padding:12px;width:34px;word-break: break-word;">'.$customer->activity_title.'</td>
        <td style="border: 1px solid; padding:12px;">'.$customer->user_input.'</td>
        <td style="border: 1px solid; padding:12px;">'.$customer->participation_grade.'</td>
          <td style="border: 1px solid; padding:12px;">'.$customer->activity_time.'</td>
        ...
        <th style="border: 1px solid; padding:12px;">Essay </th>
