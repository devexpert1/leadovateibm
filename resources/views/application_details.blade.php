														...
														<div id="ac{{$a->id}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
															<div class="panel-body">
																...
																<div class="dtls-actv">
																	...
																	<div class="actv-ss"><h5>Timing of participation     </h5>
																	   <?=$a->activity_time;?>
																	</div>
																	...
																	<div class="actv-ss"><h5>Weeks spend per year       </h5>
																	   <?=$a->week_year;?>
																		...
																		<div class="actv-ss"><h5>I intend to participate in a similar activity in college?       </h5>
																	   <?=$a->participate_similar;?>
																	</div>
