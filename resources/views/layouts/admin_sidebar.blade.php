<div class="side_bar dark_blue scroll_auto">
	...
	<li class="menu_sub">
			<a href="{{url('/')}}/admin/referral_list"> <i class="fa fa-user"></i> <span>Referral Users</span></a>
		</li>
		<li class="menu_sub">
		...
		<li class="menu_sub">
			<a href="{{url('/')}}/admin/stripe"> <i class="fa fa-file-text-o"></i> <span>Stripe Setting</span></a>
		</li>
			<li class="menu_sub">
