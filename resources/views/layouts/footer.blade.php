                ...
                <div class="col-sm-12">
                    <div class="subs-box">
                        ...
                        <div class="text-center">
                            ...
                            <p>Your trial is expired.</p>
                            <?php }else{ ?>
                            <h4 class=""><b><h5> Free trail expires in <?php echo ""
        ...
        <div class="container">
            <div class="row">
                ...
                <ul class="main-footer">
                    <?php if($fb_link){ ?>
                    <li>
                      <a href="<?php echo $fb_link; ?>" target="blank">
                    ...
                    <?php if($tweet_link){ ?>
                    <li>
                      <a href="<?php echo $tweet_link; ?>" target="blank">
                    ...
                    <?php if($google_link){ ?>
                    <li>
                      <a href="<?php echo $google_link; ?>" target="blank">
                    ...
                    <?php if($insta_link){ ?>
                    <li>
                      <a href="<?php echo $insta_link; ?>" target="blank">
                    ...
                    <li>
                      <a href="<?php echo $pinterest_link; ?>" target="blank">
