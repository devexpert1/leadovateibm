                        ...
                        if (strpos($url,'home') !== false) {?>
                         ...
                         @if(Session()->exists('user'))
                          <li>    <?php if(!empty($user)){
                            ...
                            <a href="javascript:void(0)" style="color:red !important;"class="dropdown-toggle active">Plan expired</a>
                            
                            <?php }else{ ?>
                             <a  href="javascript:void(0)" style="color:red !important;"class="dropdown-toggle active">
                             Free trail expires in   <?php echo ""
