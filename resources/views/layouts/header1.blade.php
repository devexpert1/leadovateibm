...
<head>
	...
	<link rel="stylesheet" href="{{url('/')}}/resources/assets/css/jquery.mCustomScrollbar.css"><link href="https://cdn.rawgit.com/davidstutz/bootstrap-multiselect/master/dist/css/bootstrap-multiselect.css"
    rel="stylesheet" type="text/css" />
</head>
<style>.wrap-sticky nav.navbar.bootsnav.sticked{
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{url('/all-cources')}}">
                        <img src="{{url('/')}}/resources/assets/img/logo-new1.png" class="logo" alt="Logo">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-left" data-in="#" data-out="#">
                      <!-- @if(Session()->exists('user'))
                        ...
                        <li class="title-interactive">{{$syllabus->title}}</li>
                        <li><a href="{{url('/')}}/course-details/syllabus/{{$syllabus->course_id}}" class="btn btn-warning btn-back"> <i class="fa fa-chevron-left d-none d-sm-block"></i><span class="d-sm-none">Back to Exercise</span> </a></li>
                    </ul>
