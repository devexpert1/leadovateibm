						...
						<div class="col-xl-12 col-lg-12 mb-4">
								<div class="card card-shadow mb-4">
									...
									<div class="card-body tabs-ctds">
													...
													<input type="hidden" id="course_id" name="course_id" >
														...
														<!---update--->
															...
															<div class="form-group col-sm-10 col-10">
																...
																<input type="file" name="file1" class="form-control form-control-square fileupload1" id="files1" placeholder="">
															</div>
															<div class="form-group col-sm-2 col-2">
																<img src="{{url('/')}}/resources/admin_assets/images/card-icon.png" class="upsave1" >
														...
														<div class="row">	
															<div class="form-group col-sm-12 col-12">
																<label for="exampleInputPassword10">Price</label>
																	<input type="text" name="price" class="form-control form-control-square number" id="" placeholder="">
                                        ...
                                        <div class="row">	
                                            <div class="form-group col-sm-12 col-12">
                                                    <h4 class="dvl-brdr"> Heading <a href="javascript:void(0)" 
            										class="pull-right btn btn-success btn-adda" id="add-syllabus"> Add Heading </a>
                                                    <input type="hidden" value="0" id="getvalue">
                                                    <input type="hidden" value="1" id="headings">
                                                    </h4>
                                            </div>
                                            <?php $radom=mt_rand(100000, 999999);?>
										<div class="col-md-12 rmvs">
        										<div class="row">
            										<div class="form-group col-sm-12 col-12">
            										...
            										<input type="hidden"  name="title[0][random_no]" value="<?php echo $radom;?>">
            										</div>
        										</div>
        										<div class="width-100 p_scents1 cross_headings" style="display:none;">
        										    <a href="javascript:void(0)" class="remScnt rmvs-s heading" 
        										    data-table="heading" data-random="<?php echo $radom;?>">
										...
										<div class="color_div exp_add">
										    	<div class="row lesson_drop">	
                                                <div class="form-group col-sm-12 col-12 ">
                                                <label class="label_act">Lesson</label>
                                                <select required name="title[0][lesson_id][]" class="lesson_drop_select form-control get_lessons">
                                                </select>
                                                </div>
                                            </div>
    										<div class="row activity_drop">	
                                                <div class="form-group col-sm-12 col-12">
			...
			<div class="col-lg-12">
				<div class="input-group">
					...
					<select class="form-control select_cat" required>
					    <option value="">Select Course</opton>
					    <option value="A">Activity Course</option>
					    <option value="E">Essay Course</option>
					</select>
...
var id=$('#getvalue').val();
var headings=parseInt($('#headings').val())+1;
//alert(headings);
$('#headings').val(headings);
var head=$('#headings').val();
if(head >='2')
{
    $('.cross_headings').show();
    $('.addcourse_syllabs_form .heading').show();
}
...
if(table == 'heading')
{
var minus=parseInt($('#headings').val())-1;
$('#headings').val(minus);
var req=$('#headings').val();
//alert(req);
if(req =='1')
{
    $('.addcourse_syllabs_form .heading').hide();
}
}
