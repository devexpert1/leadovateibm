										...
										<div class="bd-example table_style">
											<table class="table table-responsive-md" id="bs4-table">
												<thead>
                                                    ...
                                                    <label class="badge badge-success active_user" data-id="{{$u->id}}" data-table="users_refer" data-status="{{$u->status}}">Active </label>
                                                    @else
                                                    <label class="badge badge-danger active_user" data-id="{{$u->id}}" data-table="users_refer" data-status="{{$u->status}}">Inactive </label>
                                                    @endif
                                                    </td>
                                                    <td>
                                                        @if($u->school_year=='')
