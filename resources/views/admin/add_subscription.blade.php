			                    	...
			                    	data-next="{{url('/')}}/admin/subscriptions">
											...
											<div class="row">
												...
												<div class="form-group col-sm-6 col-12">
													...
													<input type="text" class="form-control form-control-square number" name="price" id="" placeholder="Ex: 49.99">
												</div>
												<div class="form-group col-sm-6 col-12">
												...
												<button id="myButton" class="btn btn-secondary" type="button">
														Cancel
													</button>
												</div>
											</div>
