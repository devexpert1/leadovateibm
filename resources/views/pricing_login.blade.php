            ...
            <div class="row">
				...
				<div class="col-lg-4 col-md-6">
					<div class="pricing-box text-center mb-30">
						...
						<div class="price-btn">
							<a href="javascript:void(0);"  data-id="{{$sub->id}}" data-feature="{{$sub->features}}" class="confirm_package btn choose_plan" >Choose Plan</a>
						</div>
					</div>
				</div>
				@endforeach
				@endif
				<!--button type="button"  class="next_pricing btn btn-default btn-block  check_pack ">Submit</a--->
				</form>
			</div>
		</div>
	</section>
