...
a.btn.btn-default.btn-block.login-bns.fb-btn {
    font-size: 10px;
}
 </style>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                    <div class="login-pgs">
                        ...
                        @csrf
							...
							<?php
							echo 
							'<a  class="btn btn-default btn-block login-bns fb-btn" href="https://www.linkedin.com/uas/oauth2/authorization?response_type=code&client_id=86ykoyctpdkqkm&redirect_uri=https://leadovate.com/staging&state=98765EeFWf45A53sdfKef4233&scope=r_liteprofile r_emailaddress"><i class="fab fa-linkedin-in"></i>LinkedIn</a>';
							?></div>
								
								<!--div class="col-md-6">
									<a href="#" class="btn btn-default btn-block login-bns fb-btn"><i class="fab fa-facebook-f"></i>Login with Facebook</a>
								</div>
								<div class="col-md-6">
									<a href="#" class="btn btn-default btn-block login-bns google-btn"><i class="fab fa-google-plus-g"></i>Login with Google</a>
								</div-->
							</div>
							<div class="row">
								<div class="col-md-12">
...
$('.loginform').validate({
   rules: {
      ...
      /* submitHandler: function(form) {
          ...
          $('.loginbtn').html('<i class="fa fa-spinner fa-spin"></i> Porcessing...');
           // $('.loginform').submit();
